...
void SaveRecord5(const char* filename)
{
	FILE* fp = NULL;
...
void addRecord5(int Dir, long Time)
{
	int order = 0;
	for (int i = 0; i < RecOrder; i++)
	{
...
void LoadRecord5(const char* filename)
{
	FILE* fp = NULL;
